    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form role="form" class="form-horizontal" action="/group/id">
                    ...
                    <input type="submit" id="showGroup" value="Show group">
                </form>
                <form role="form" class="form-horizontal" action="/group/delete" method="post">
                    <select class="selectpicker form-control form-group" name="groupDel">
                        <option value="-1">Default</option>
                        <c:forEach items="${groups}" var="group">
                            <option value="${group.id}">${group.name}</option>
                        </c:forEach>
